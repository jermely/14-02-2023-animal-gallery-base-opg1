...
function createLoadingScreen() {
  ...
  let fetchingTitle = document.createElement("h1");
  fetchingTitle.innerText = "Fetching data";

  let bufferFigure = document.createElement("figure");
  let bufferImg = document.createElement("img");
  bufferImg.src = "assets/img/giphy.gif";
  bufferImg.alt = "Loading screen";
  bufferImg.classList.add("loadingGif");

  myApp.appendChild(loadingContainer);
  loadingContainer.appendChild(fetchingTitle);
  loadingContainer.appendChild(bufferFigure);
  bufferFigure.appendChild(bufferImg);
}
...
function buildCard(myAnimalData) {
  ...
  cardArticle.classList.add("galleryCard");

  let cardh2 = document.createElement("h2");
  cardh2.innerText = myAnimalData.name;
  ...
  myApp.appendChild(cardArticle);
  cardArticle.appendChild(cardh2);
  cardArticle.appendChild(cardFigure);
  cardFigure.appendChild(cardImg);
  cardArticle.appendChild(cardDesc);
}
